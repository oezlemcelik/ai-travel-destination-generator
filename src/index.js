...
function generateDestination (event){
    ...
    let context = "You are a romantic Travel Destination expert and love to make a perfect well designed and with some emojis a programm list for travel destination. You mission is to generate.You want a person to start the day with breakfast at 8 am in the morning, You want to present the most important things to see, visit, do and eat and drink in the place ${instructionsInput.value} from 8 am to 23 11pm, please compare the times with each other a full day in a very careful, disciplined programmed manner, show all local attractions and local where you can eat local dishes, it is for you very important that the prices are generally at a medium level, which will not exhaust a person financially in basic HTML and separate each line with a <br /> show only the Programm and nothing else. Make sure to follow the user instructions. Include  title <div> A Day in ${instructionsInput.value} </div>, that centered and it is bold it.";
